...
class User(models.Model):
    ...
    start_date = models.DateTimeField('data published')
...
class Challenge(models.Model):
    ...
    participants_id = models.ForeignKey(User, on_delete=models.CASCADE, null=True, related_name='participants_id')
...
class Activity(models.Model):
    id = models.ForeignKey(User, on_delete=models.CASCADE, related_name='a_user', primary_key=True)
    challenge_id = models.ForeignKey(Challenge, on_delete=models.CASCADE, related_name='atchallenge_id')
...
class Challenge_mypage(models.Model):
    id = models.ForeignKey(User, on_delete=models.CASCADE, related_name='c_user', primary_key=True)
...
class Stamp(models.Model):
    id = models.ForeignKey(User, on_delete=models.CASCADE, related_name='stp_user', primary_key=True)
    activity_id = models.ForeignKey(User, on_delete=models.CASCADE, related_name='activity_id', null=True) 
    challenge_id = models.CharField(max_length = 45)

class N_badge(models.Model):
    id = models.ForeignKey(User, on_delete=models.CASCADE, related_name='nb_user', primary_key=True)
...
class Challenge_Badge(models.Model):
    id = models.ForeignKey(User, on_delete=models.CASCADE, related_name='cb_user', primary_key=True)
    challenge_past = models.ForeignKey(Challenge_mypage, on_delete=models.CASCADE, null=True, related_name='cbchallenge_past')

class Shop(models.Model):
    id = models.ForeignKey(User, on_delete=models.CASCADE, related_name='shop_user', primary_key=True)
...
class Point(models.Model):
    id = models.ForeignKey(User, on_delete=models.CASCADE, related_name='p_user', primary_key=True)
...
class Quiz_mypage(models.Model):
    id = models.ForeignKey(User, on_delete=models.CASCADE, related_name='q_user', primary_key=True)
